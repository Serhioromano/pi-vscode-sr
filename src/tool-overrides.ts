...
import { applyEdits, createReviewAndWait, setProjectCwd } from "./review-lifecycle.js";

// ─── Override `write` ────────────────────────────────────────────────

export function registerWriteOverride(pi: ExtensionAPI) {
    pi.registerTool({
        name: "write",
...
export function registerEditOverride(pi: ExtensionAPI) {
    pi.registerTool({
        name: "edit",
